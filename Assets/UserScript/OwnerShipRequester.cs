...
public class OwnerShipRequester : MonoBehaviourPun
{
    ...
    public static class gameobjects {
        ...
        public static GameObject outerWall;
    ...
    public static class tags
    {
        ...
        public static readonly string outerWall = "outerWall";
    ...
    public static class photonViews
    {
        ...
        public static PhotonView outerWall;
        ...
        public static void initViews() {
            ...
            outerWall = gameobjects.outerWall.GetPhotonView();
    ...
    public void requestCubeOwnerShip()
    {
        ...
        if (PhotonNetwork.IsConnected)
        {
            ...
            photonViews.mainCube.RequestOwnership(); 
            photonViews.outerWall.RequestOwnership(); 
            Debug.Log("LocalCatch : photonView.isRuntimeInstantiated");

            photonViews.mainCube.RPC("Catch", RpcTarget.All); // it was other and it has been modified to All for testing purposes
    ...
    public void requestAllHandlesOwnerShip()
    {
        ...
        if (PhotonNetwork.IsConnected)
        {
            ...
            photonViews.frontHandle.RequestOwnership();
            //photonViews.backHandle.TransferOwnership(PhotonNetwork.LocalPlayer);
            photonViews.backHandle.RequestOwnership(); 
